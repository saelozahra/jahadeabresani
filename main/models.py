...
class project(models.Model):
    ...
    #
    mojavez = models.FileField(upload_to='files/images/project/mojavez', blank=True, null=True, verbose_name='مجوزهای پروژه', default="")
    mostanadat = models.FileField(upload_to='files/images/project/mostanadat', blank=True, null=True, verbose_name='مستندات پروژه', default="")
    file_ha = models.FileField(upload_to='files/images/project', blank=True, null=True, verbose_name='فایلهای پروژه', default="")
    #
