...
class subproject(models.Model):
    ...
    view_count  = models.IntegerField(default=0,editable=False,  verbose_name='تعداد بازدید' )
    #
    mojavez     = models.FileField(upload_to='files/images/subproject/mojavez', verbose_name='مجوزهای پروژه', default="")
    mostanadat  = models.FileField(upload_to='files/images/subproject/mostanadat', verbose_name='مستندات پروژه', default="")
    file_ha     = models.FileField(upload_to='files/images/subproject', verbose_name='فایلهای پروژه', default="")
    #
    marhale1     = models.CharField(max_length=202, default="", verbose_name='مرحله 1')
    marhale2     = models.CharField(max_length=202, default="", verbose_name='مرحله 2')
    marhale3     = models.CharField(max_length=202, default="", verbose_name='مرحله 3')
    marhale4     = models.CharField(max_length=202, default="", verbose_name='مرحله 4')
    marhale5     = models.CharField(max_length=202, default="", verbose_name='مرحله 5')
    marhale6     = models.CharField(max_length=202, default="", verbose_name='مرحله 6')
    marhale7     = models.CharField(max_length=202, default="", verbose_name='مرحله 7')
    marhale8     = models.CharField(max_length=202, default="", verbose_name='مرحله 8')
    marhale9     = models.CharField(max_length=202, default="", verbose_name='مرحله 9')
    marhale10    = models.CharField(max_length=202, default="", verbose_name='مرحله 10')
    marhale11    = models.CharField(max_length=202, default="", verbose_name='مرحله 11')
    marhale12    = models.CharField(max_length=202, default="", verbose_name='مرحله 12')
    marhale13    = models.CharField(max_length=202, default="", verbose_name='مرحله 13')
    marhale14    = models.CharField(max_length=202, default="", verbose_name='مرحله 14')
    marhale15    = models.CharField(max_length=202, default="", verbose_name='مرحله 15')
    marhale16    = models.CharField(max_length=202, default="", verbose_name='مرحله 16')
    marhale17    = models.CharField(max_length=202, default="", verbose_name='مرحله 17')
    marhale18    = models.CharField(max_length=202, default="", verbose_name='مرحله 18')
    marhale19    = models.CharField(max_length=202, default="", verbose_name='مرحله 19')
    marhale20    = models.CharField(max_length=202, default="", verbose_name='مرحله 20')
